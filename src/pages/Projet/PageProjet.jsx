...
export default function PageProjet({ project: p, isMobile, isTablet, navigate }) {
        ...
        <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "2fr 1fr", gap: isMobile ? 48 : 64, alignItems: "start" }}>
          ...
          <div>
            ...
            <div style={{ padding: "28px 32px", background: "rgba(26,31,56,0.5)", border: "1px solid rgba(212,165,116,0.2)", borderRadius: 8, backdropFilter: "blur(20px)", marginBottom: 40, position: "relative" }}>
              ...
              {[
                { title: "Contexte",         value: p.contexte     || "[Décris le contexte du projet…]" },
                { title: "Ce que j'ai fait", value: p.contribution || "[Décris ton rôle et tes contributions…]" },
                { title: "Résultats & impact", value: p.resultats  || "[Décris les résultats obtenus…]" },
              ].map((section, idx) => (
